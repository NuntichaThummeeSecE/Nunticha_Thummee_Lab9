...
function filterByClassification(classification) {
    const filteredArtworks = currentArtworks.filter(artwork => {
        ...
        } else if (classification === `Painting`) {
            return artworkClassification === `painting`; //return only painting
        } else if (classification === `Miniatures`) {
            return artworkClassification === `miniatures`; //return only miniatures
        } else {
            return false;
        }
    });
